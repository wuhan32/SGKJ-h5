<template>
  <div class="firstExamine">
    ...
    <van-form @submit="onSubmit">
      <main>
        <van-tabs type="card">
          <van-tab title="右眼">
            <ul class="main-top">
              <li class="main-top-one">
                <select name class="main-top-tab" v-model="inputList.rightTeleopsia1">
                  <option value="rightTeleopsia">视远</option>
                  <option value="rightNearVision">视近</option>
                  <option value="rightCheckMirror">镜止</option>
                </select>
                <select name class="main-top-tab" v-model="inputList.rightTeleopsia2">
              ...
              <li>
                <select name class="main-top-tab" v-model="inputList.rightFrame">
                ...
                <div>
                  <van-field   v-model="inputList.value1" />
                </div>
                <div>
                  <van-field   v-model="inputList.value2" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.rightNakedLook" label="裸视" />
                </div>
                <div>
                  <van-field   v-model="inputList.rightNakedLook1" />
                </div>
              </li>
              <li>     
                <div>
                  <van-field   v-model="inputList.rightSph" label="球镜" />
                </div>
                <div>
                  <van-field   v-model="inputList.rightSph1" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.rightColumnMirror" label="柱镜" />
                </div>
                <div>
                  <van-field   v-model="inputList.rightColumnMirror1" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.rightAxialView" label="轴位" />
                </div>
                <div>
                  <van-field   v-model="inputList.rightAxialView1" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.rightLingMirror" label="棱镜" />
                </div>
                <div>
                  <van-field   v-model="inputList.rightLingMirror1" />
                </div>
              </li>
              <li>
                <span>底向</span>
                <div>
                  <select name v-model="inputList.rightEndThe">
                ...
                <div>
                  <select name v-model="inputList.rightEndThe1">
              ...
              <li>
                <div>
                  <van-field   label="视力" v-model="inputList.rightVision" />
                </div>
                <div>
                  <van-field   v-model="inputList.rightVision1" />
                </div>
              </li>
            </ul>
            <p class="title">诊断</p>
            <ul class="main-buttom">
              <li>
                <span>立体</span>
                <select name v-model="inputList.rightStereoscopic">
              ...
              <li>
                <span>融合</span>
                <select name v-model="inputList.rightFuse">
              ...
              <li>
                <span>色觉</span>
                <select name v-model="inputList.rightColourVision ">
              ...
              <li>
                <span>红绿</span>
                <select name v-model="inputList.rightRedGreen ">
              ...
              <li>
                <van-field   v-model="inputList.rightCentrometer" label="瞳距" />
                <p>mm</p>
              </li>
              <li>
                <van-field   v-model="inputList.rightPupilHigh" label="瞳高" />
                <p>mm</p>
              </li>
              <li>
                <van-field   v-model="inputList.rightADD" label="ADD" />
                <p>mm</p>
              </li>
            </ul>
          </van-tab>
          <van-tab title="左眼">
            <ul class="main-top">
              <li class="main-top-one">
                <select name class="main-top-tab" v-model="inputList.leftTeleopsia1">
                  <option value="leftTeleopsia">视远</option>
                  <option value="leftNearVision">视近</option>
                  <option value="leftCheckMirror">镜止</option>
                </select>
                <select name class="main-top-tab" v-model="inputList.leftTeleopsia2">
              ...
              <li>
                <select name class="main-top-tab" v-model="inputList.leftFrame">
                ...
                <div>
                  <van-field   v-model="inputList.value3" />
                </div>
                <div>
                  <van-field   v-model="inputList.value4" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.leftNakedLook" label="裸视" />
                </div>
                <div>
                  <van-field   v-model="inputList.leftNakedLook1" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.leftSph" label="球镜" />
                </div>
                <div>
                  <van-field   v-model="inputList.leftSph1" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.leftColumnMirror" label="柱镜" />
                </div>
                <div>
                  <van-field   v-model="inputList.leftColumnMirror1" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.leftAxialView" label="轴位" />
                </div>
                <div>
                  <van-field   v-model="inputList.leftAxialView1" />
                </div>
              </li>
              <li>
                <div>
                  <van-field   v-model="inputList.leftLingMirror" label="棱镜" />
                </div>
                <div>
                  <van-field   v-model="inputList.leftLingMirror1" />
                </div>
              </li>
              <li>
                <span>底向</span>
                <div>
                  <select name v-model="inputList.leftEndThe">
                ...
                <div>
                  <select name v-model="inputList.leftEndThe1">
              ...
              <li>
                <div>
                  <van-field   label="视力" v-model="inputList.leftVision" />
                </div>
                <div>
                  <van-field   v-model="inputList.leftVision1" />
                </div>
              </li>
            </ul>
            <p class="title">诊断</p>
            <ul class="main-buttom">
              <li>
                <span>立体</span>
                <select name v-model="inputList.leftStereoscopic">
              ...
              <li>
                <span>融合</span>
                <select name v-model="inputList.leftFuse">
              ...
              <li>
                <span>色觉</span>
                <select name v-model="inputList.leftColourVision ">
              ...
              <li>
                <span>红绿</span>
                <select name v-model="inputList.leftRedGreen ">
              ...
              <li>
                <van-field   v-model="inputList.leftCentrometer" label="瞳距" />
                <p>mm</p>
              </li>
              <li>
                <van-field   v-model="inputList.leftPupilHigh" label="瞳高" />
                <p>mm</p>
              </li>
              <li>
                <van-field   v-model="inputList.leftADD" label="ADD" />
                <p>mm</p>
              </li>
            </ul>
          </van-tab>
      ...
      <footer>
        <van-button round size="small" class="footerBt-left" native-type="submit">提交</van-button>
      </footer>
    </van-form>
  </div>
</template>
...
export default {
  data() {
    return {
      ...
      inputList: {
        ...
        value3: "",
        value4: "",
        leftTeleopsia1: "leftTeleopsia",
        leftTeleopsia2: "leftTeleopsia1",
        leftFrame: "leftFrame",
        leftNakedLook: "",
        leftNakedLook1: "",
        leftSph: "",
        ...
        leftPupilHigh: "",
        leftADD: "",
        rightTeleopsia1: "rightTeleopsia",
        rightTeleopsia2: "rightTeleopsia1",
  ...
  created() {
    ...
    this.clickList.forEach((element, index) => {
      this.savemessage.inputList.push({
        ...this.inputList,
  ...
  methods: {
    ...
    async gosubmit() {
      ...
      let targetIndex = this.savemessage.inputList.findIndex(
      ...
      if (
        optometryDetailModelViews.length == this.savemessage.inputList.length
      ) {
    ...
    cut(clickListtag) {
      ...
      let nextPutList = this.savemessage.inputList.find(
