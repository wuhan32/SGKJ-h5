        ...
        <van-tabs type="card" @click="onClick">
          <van-tab title="右眼">
            <ul>
              <li>
                <van-field
                  v-model="savemessage.inputList.rightEyeball"
                  label="球镜"
                />
              </li>
              <li>
              ...
              <li>
                <van-field
                  v-model="savemessage.inputList.rightAxialDirection"
                  label="轴向"
                />
              </li>
              <li>
                <van-field v-model="savemessage.inputList.rightKF" label="KF" />
              </li>
              <li>
                <van-field v-model="savemessage.inputList.rightKS" label="KS" />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.rightkValue"
                  label="K值"
                />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.rightCYL"
                  label="CYL"
                />
              </li>
              <li>
                <van-field v-model="savemessage.inputList.rightAX" label="AX" />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.rightAVG"
                  label="AVG"
                />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.rightROCS"
                  label="ROCS"
                />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.rightROCF"
                  label="ROCF"
                />
              </li>
              <li></li>
          ...
          <van-tab title="左眼">
            <ul>
              <li>
                <van-field
                  v-model="savemessage.inputList.leftEyeball"
                  label="球镜"
                />
              </li>
              <li>
              ...
              <li>
                <van-field
                  v-model="savemessage.inputList.leftAxialDirection"
                  label="轴向"
                />
              </li>
              <li>
                <van-field v-model="savemessage.inputList.leftKF" label="KF" />
              </li>
              <li>
                <van-field v-model="savemessage.inputList.leftKS" label="KS" />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.leftkValue"
                  label="K值"
                />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.leftCYL"
                  label="CYL"
                />
              </li>
              <li>
                <van-field v-model="savemessage.inputList.leftAX" label="AX" />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.leftAVG"
                  label="AVG"
                />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.leftROCS"
                  label="ROCS"
                />
              </li>
              <li>
                <van-field
                  v-model="savemessage.inputList.leftROCF"
                  label="ROCF"
                />
              </li>
              <li></li>
